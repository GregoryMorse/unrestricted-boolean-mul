import UnrestrictedBooleanMul.Phase3.JetShadow
...
theorem SupportedK0Two.booleanContraction
  ...
  intro z j hz
  unfold UnrestrictedBooleanMul.Phase3.booleanContraction
...
theorem SupportedK0Two.booleanContraction_zeroPlace
    (M : LinearForm) :
    SupportedK0Two
      (UnrestrictedBooleanMul.Phase3.booleanContraction M
        (rationalPlaceTwo 0)) :=
...
theorem SupportedK0Two.affine_mul_coordinateQuadratic
  ...
  have hw : SupportedK0Two
      (UnrestrictedBooleanMul.Phase3.vectorWedge u v) :=
