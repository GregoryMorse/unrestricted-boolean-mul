import UnrestrictedBooleanMul.N5.QuadraticReturnHistoryZeroOneAlignedCorrectionZeroRaw
import UnrestrictedBooleanMul.N3Certificate
import UnrestrictedBooleanMul.N5.QuadraticReturnHistoryZeroOneAlignedBase

/-!
# Affine normalization bridge: `ZeroOneAlignedCorrectionZero`
...
/-- Original semantic generators selected by the `ZeroOneAlignedCorrectionZero` unit certificate. -/
def zeroOneAlignedCorrectionZeroOriginalConstraint (v : Fin 71 → F₂) : Fin 16 → F₂ :=
...
structure ZeroOneAlignedCorrectionZeroSubstitutions (v : Fin 71 → F₂) : Prop where
  x1 : v 21 = 0
  x2 : v 22 = 0
  x3 : v 23 = 0
  x4 : v 24 = 0
  ...
  correctionTarget6 : v 68 = v 11 + v 42
  correctionTarget7 : v 69 = v 11 + v 14 + v 42 + v 45
  correctionTarget4 : v 66 = v 12 + v 43
  factorLinear2 : v 43 = v 12
  correctionTarget1 : v 63 = 0
  factorLinear4 : v 45 = v 11 + v 14 + v 42
  factorLinear7 : v 48 = v 17
  factorLinear1 : v 42 = v 11
...
theorem zeroOneAlignedCorrectionZeroReducedConstraint_eq_original
    (v : Fin 71 → F₂)
    (h : ZeroOneAlignedCorrectionZeroSubstitutions v)
    (i : Fin 16) :
    zeroOneAlignedCorrectionZeroReducedConstraint v i = zeroOneAlignedCorrectionZeroOriginalConstraint v i := by
  fin_cases i <;>
    simp [zeroOneAlignedCorrectionZeroReducedConstraint, zeroOneAlignedCorrectionZeroOriginalConstraint,
...
inconsistent. -/
theorem zeroOneAlignedCorrectionZero_inconsistent_of_original
    (v : Fin 71 → F₂)
    (hsub : ZeroOneAlignedCorrectionZeroSubstitutions v)
    (hzero : ∀ i : Fin 16, zeroOneAlignedCorrectionZeroOriginalConstraint v i = 0) :
    False := by
  apply zeroOne_aligned_correctionZero_reduced_inconsistent v
  intro i
  rw [zeroOneAlignedCorrectionZeroReducedConstraint_eq_original v hsub i]
  exact hzero i
