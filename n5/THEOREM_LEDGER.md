...
| Lemma 11.4, target-clean second jet | `N5.targetTwoSpace_inf_targetCleanSecondJetSpace`, `N5/TargetClean.lean` | four-coordinate functional and symbolic 4-by-4 contradiction | in progress (equation (11.6) checked; affine decomposable exclusion and equation (11.7) remain) |
