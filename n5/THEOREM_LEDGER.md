...
| Lemma 11.2, envelope kernel and shadows | `N5.targetCapacitySpace_le_firstOrderEnvelope_of_finrank_le_one`, `N5.firstOrderEnvelopePolarized_ker_eq_local`, `N5.firstOrderPlaneCoeff_eq_local_of_kernel_of_ne_zero`, `N5.firstOrderPlaneCoeff_difference_classification`, `N5.independentPlane_cubic_recovers_external_shadow`, `N5.singleDirection_cubic_forces_external_shadow_zero`, `N5.envelope_shadow`; `N5/FirstOrderEnvelope.lean`, `N5/EnvelopeKernel.lean`, `N5/ShadowRecovery.lean` | exact relation map, local radical structure, Pluecker classification, and basis-free external shadow recovery | in progress (defect-at-most-one base envelope, equation (11.3), zero-wedge/equal-wedge classifications, and both independent and rank-one external cubic-to-quadratic shadow lemmas checked; local-plane transport and the complete target-shadow wrapper remain) |
