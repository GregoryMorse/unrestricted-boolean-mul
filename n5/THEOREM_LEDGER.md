...
| Nonextremal envelope deficit interface | `N5.E2.wStar_suffixDeficit_positive`, `N5.E2.wPQ_suffixDeficit_positive`, `N5.E2.wThreeP_suffixDeficit_positive`; `N5/E2/StableInterface.lean` | exact ANF envelope ranks plus a joint rank-eight stability certificate | checked (interface; feedback stability remains part of Theorem 10.4) |
...
| Circuit-facing first-order envelope collision | `N5.quadraticOverlapCubic_basisPair`, `N5.semanticEnvelope_shadow`, `N5.sameSpan_actualLowProducts_ne_missingTargetANF`; `N5/CubicOverlapBasis.lean`, `N5/EnvelopeSemantic.lean` | literal high quotient, basis-invariant exact cubic overlap, quartic tensor, and quadratic projection | checked (arbitrary equal-overlap pairs and actual products under every presentation of one intrinsic plane) |
...
| Lemma 12.2, rank-one normalization | `N5.rankOneColour_normalize`, `N5.rankOne_targetClean_lower_parts_zero`, `N5.rankOne_targetClean_absorption_impossible`; `N5/ColourNormalization.lean`, `N5/RankOneTargetClean.lean`, `N5/RankOneEscape.lean` | same-line factor rewiring, equality of wire extensions, Boolean absorption, target-clean exclusion, and homogeneous exterior kernels | checked (equations (12.3)--(12.4), lower-part vanishing, and the final high-wire contradiction) |
| Theorem 12.3, three-colour saturation | `N5.bornThreeHighDirections_linearIndependent`, `N5.quadraticBase_defect_eq_zero_of_bornColours_mem`, and planned `N5.threeColour_saturation`; `N5/ThreeColour.lean`, `N5/ColourHighQuotient.lean` | algebraic third-direction birth in the literal high quotient and the `e+s<=3` old-product budget branch | in progress (quotient-level third-direction birth and circuit-state `e=0` consequence checked; target-shadow saturation remains) |
