...
| Lemma 11.2, envelope kernel and shadows | `N5.targetCapacitySpace_le_firstOrderEnvelope_of_finrank_le_one`, `N5.firstOrderEnvelopePolarized_ker_eq_local`, `N5.firstOrderPlaneCoeff_eq_local_of_kernel_of_ne_zero`, `N5.firstOrderPlaneCoeff_difference_classification`, `N5.independentPlane_cubic_recovers_radical_shadow`, `N5.singleDirection_cubic_forces_radical_shadow_zero`, `N5.closedPlaceTargetPlane_cubic_recovers_external_shadow`, `N5.rationalPairPlane_cubic_recovers_external_shadow`, `N5.lowProductQuadraticShadow_rotate_right`, `N5.two_rotations_shadow_mod_submodule`, `N5.rankOneShadow_not_missingCoset`, `N5.rationalZero_shadow_decomposition`, `N5.rationalZero_shadow_not_missingCoset`, `N5.envelope_shadow`; `N5/FirstOrderEnvelope.lean`, `N5/EnvelopeKernel.lean`, `N5/ShadowRecovery.lean`, `N5/LocalShadow.lean`, `N5/LowProductShadow.lean`, `N5/RankOneShadow.lean`, `N5/IndependentShadow.lean` | exact relation map, local radical structure, Pluecker classification, basis-free external shadow recovery, algebraic Boolean quadratic-shadow rotation laws, and rank-one missing-coset rigidity | in progress (defect-at-most-one base envelope, equation (11.3), zero-wedge/equal-wedge classifications, arbitrary-frame shadow recovery, all seven exceptional planes in both independent and rank-one forms, one-/two-rotation shadow invariance, all three projective rank-one shadow presentations, and a structural canonical rational-zero decomposition into the old envelope plus two decomposable forms checked; the remaining symmetry transports and decomposable-defect bridge remain) |
