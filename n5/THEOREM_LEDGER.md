...
| Lemma 12.2, rank-one normalization | `N5.rankOneColour_normalize`, `N5.missingCoset_lower_parts_zero`; `N5/ColourNormalization.lean`, `N5/MissingCosetQuadratic.lean` | same-line factor rewiring, equality of wire extensions, Boolean absorption, and homogeneous exterior kernels | in progress (algebraic normalization, equations (12.3)--(12.4), and the full missing-coset homogeneous contradiction checked; target-clean representative reduction remains) |
