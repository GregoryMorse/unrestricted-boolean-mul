...
| Lemma 11.1, missing-coset rigidity | `N5.missingCoset_not_rankTwoHankel`, `N5.missingCoset_not_sum_two_decomposable`, `N5.missingCoset_vectorWedge_ker_eq_bot`, `N5/FirstOrderEnvelope.lean`, `N5/MissingCoset.lean` | closed-place envelope equation, symbolic secant rank, exterior factorization | checked (cross-rank and degree-one kernel; degree-two kernel remains) |
| Lemma 11.2, envelope kernel and shadows | `N5.targetCapacitySpace_le_firstOrderEnvelope_of_finrank_le_one`, `N5.envelope_shadow`, `N5/FirstOrderEnvelope.lean` | exact relation map and local radical structure | in progress (defect-at-most-one base envelope checked; wedge kernel and shadows remain) |
| Lemma 11.4, target-clean second jet | `N5.targetTwoSpace_inf_targetCleanSecondJetSpace`, `N5.targetCleanProjectedMatrix_not_symmetricRankOne`, `N5/TargetClean.lean`, `N5/TargetCleanMatrix.lean` | four-coordinate functional and symbolic 4-by-4 contradiction | in progress (equation (11.6), the exact first-order basis, retained projection, and matrix (11.8) contradiction checked; affine decomposable exclusion and equation (11.7) remain) |
