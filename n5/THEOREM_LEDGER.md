...
| Lemma 11.2, envelope kernel and shadows | `N5.targetCapacitySpace_le_firstOrderEnvelope_of_finrank_le_one`, `N5.firstOrderEnvelopePolarized_ker_eq_local`, `N5.firstOrderPlaneCoeff_eq_local_of_kernel_of_ne_zero`, `N5.firstOrderPlaneCoeff_difference_classification`, `N5.envelope_shadow`; `N5/FirstOrderEnvelope.lean`, `N5/EnvelopeKernel.lean` | exact relation map, local radical structure, and Pluecker classification | in progress (defect-at-most-one base envelope, equation (11.3), independent zero-wedge planes, and the zero/one/two-rotation equal-wedge classification checked; cubic-to-quadratic shadow recovery remains) |
