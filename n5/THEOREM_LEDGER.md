...
| Circuit-facing first-order envelope collision | `N5.quadraticOverlapCubic_basisPair`, `N5.semanticEnvelope_shadow`, `N5.basisChange_actualLowProducts_ne_missingTargetANF`; `N5/CubicOverlapBasis.lean`, `N5/EnvelopeSemantic.lean` | literal high quotient, basis-invariant exact cubic overlap, quartic tensor, and quadratic projection | checked (arbitrary equal-overlap pairs and actual products under all six presentations of one plane) |
