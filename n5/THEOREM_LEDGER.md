...
| Lemma 11.1, missing-coset rigidity | `N5.missingCoset_not_rankTwoHankel`, `N5.missingCoset_not_sum_two_decomposable`, `N5.missingCoset_vectorWedge_ker_eq_bot`, `N5.canonicalRankThree_wedge_ker_eq_span`; `N5/FirstOrderEnvelope.lean`, `N5/MissingCoset.lean`, `N5/MissingCosetQuadratic.lean` | closed-place envelope equation, symbolic secant rank, exterior factorization, and three-pivot canonical kernel | in progress (cross-rank, degree-one kernel, and canonical degree-two kernel checked; basis-change transport of the degree-two kernel remains) |
...
| Lemma 12.2, rank-one normalization | `N5.rankOneColour_normalize`, `N5/ColourNormalization.lean` | same-line factor rewiring, equality of wire extensions, and both Boolean absorption identities | in progress (algebraic normalization and equations (12.3)--(12.4) checked; target-clean representative reduction remains) |
