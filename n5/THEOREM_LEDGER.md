...
| Theorem 6.2, displacement bound | `N5.displacement_rank_le`, `N5/DisplacementProfile.lean` | exact represented-place profile checked; Fano relation pivots remain | in progress |
