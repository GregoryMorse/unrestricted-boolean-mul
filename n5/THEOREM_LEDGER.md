...
| Circuit-facing first-order envelope collision | `N5.semanticEnvelope_shadow`, `N5.samePlane_actualLowProducts_ne_missingTargetANF`; `N5/EnvelopeSemantic.lean` | literal high quotient, exact cubic overlap, quartic tensor, and quadratic projection | checked (arbitrary equal-overlap pairs and actual same-plane products) |
