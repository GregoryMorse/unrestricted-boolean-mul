...
| Quadratic/high defect split | `N5.flagDefectRank_eq_quadratic_add_high`, `N5.stateHighImage_finrank`, `N5.DefectLegalSuffix.quadraticDefect_add_high_le_three`; `N5/HighDefect.lean` | quotient by the degree-at-most-two ANFs and exact finite-dimensional defect ledger | checked |
