...
| Lemma 11.1, missing-coset rigidity | `N5.missingCoset_not_rankTwoHankel`, `N5.missingCoset_not_sum_two_decomposable`, `N5.missingCoset_vectorWedge_ker_eq_bot`, `N5.canonicalRankThree_wedge_ker_eq_span`, `N5.canonicalRankThree_vectorWedge_ker_eq_bot`; `N5/FirstOrderEnvelope.lean`, `N5/MissingCoset.lean`, `N5/MissingCosetQuadratic.lean` | closed-place envelope equation, symbolic secant rank, exterior factorization, and three-pivot canonical kernels | in progress (cross-rank, general degree-one kernel, and both canonical kernels checked; basis-change transport of the degree-two kernel remains) |
| Lemma 11.2, envelope kernel and shadows | `N5.targetCapacitySpace_le_firstOrderEnvelope_of_finrank_le_one`, `N5.firstOrderEnvelopePolarized_ker_eq_local`, `N5.firstOrderPlaneCoeff_eq_local_of_kernel_of_ne_zero`, `N5.envelope_shadow`, `N5/FirstOrderEnvelope.lean`, `N5/EnvelopeKernel.lean` | exact relation map, local radical structure, and Pluecker classification | in progress (defect-at-most-one base envelope, equation (11.3), and the independent zero-wedge plane classification checked; shadows remain) |
...
| Lemma 12.2, rank-one normalization | `N5.rankOneColour_normalize`, `N5.canonicalRankOne_lower_parts_zero`; `N5/ColourNormalization.lean`, `N5/MissingCosetQuadratic.lean` | same-line factor rewiring, equality of wire extensions, Boolean absorption, and homogeneous exterior kernels | in progress (algebraic normalization, equations (12.3)--(12.4), and the canonical homogeneous contradiction checked; target-clean representative reduction and missing-coset transport remain) |
